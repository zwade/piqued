...
/**
 * From https://github.com/zwade/ruulang/blob/master/scripts/new-release.mts
 * License MIT
 */
...
const baseURL = new URL("https://api.github.com/repos/zwade/piqued/");
const authToken = process.env.PIQUED_ACCESS_TOKEN!;
