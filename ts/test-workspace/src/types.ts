...
export namespace CreditApplicationOverrideConfiguration {
    ...
    export const spec = {
        ...
        fields: () => [
            ...
            ["slug", String],
            ["name", String],
            ["inheritance_stack", { "kind": "array", "spec": String }],
            ["is_active", Boolean],
        ] as const,
    };
}
...
export namespace PersonaCache {
    ...
    export const spec = {
        ...
        fields: () => [
            ...
            ["persona_task_id", String],
            ["failure_reasons", { "kind": "array", "spec": Personaerror.spec }],
        ] as const,
    };
}
...
export namespace ConversationEvent {
    export type t = {
        ...
        "seller_side_pdf_snapshot": number;
        "buyer_side_pdf_snapshot": number;
    };
    ...
    export const spec = {
        ...
        fields: () => [
            ...
            ["requested_changes_steps", { "kind": "array", "spec": Relationshipstep.spec }],
            ["requested_changes_notes", String],
            ["approved_credit_terms", String],
            ["approved_credit_limit", Number],
            ["rejected_reason", String],
...
export namespace BackfillEmailJob {
    export type t = {
        ...
        "interval_between_emails_in_seconds": number;
    };
...
export namespace TradeReferenceConfiguration {
    ...
    export const spec = {
        ...
        fields: () => [
            ...
            ["created_at", Date],
            ["enabled", Boolean],
            ["allowlist", { "kind": "array", "spec": String }],
            ["denylist", { "kind": "array", "spec": String }],
            ["additional_remarks_context", String],
            ["default_peer_reference_data_sharing_optin", Boolean],
        ] as const,
    };
...
export namespace EmailLog {
    ...
    export const spec = {
        ...
        fields: () => [
            ["id", Number],
            ["email_from", String],
            ["emails_to", { "kind": "array", "spec": String }],
            ["credit_app_id", Number],
            ["template_name", String],
            ["created_at", Date],
            ["updated_at", Date],
...
export namespace Company {
    ...
    export const spec = {
        ...
        fields: () => [
            ...
            ["business_type", String],
            ["is_tax_exempt", Boolean],
            ["exemption_documents", { "kind": "array", "spec": String }],
            ["po_required", Boolean],
            ["duns", String],
            ["creditsafe_id", String],
            ["efx_id", String],
...
export namespace Relationship {
    ...
    export const spec = {
        ...
        fields: () => [
            ...
            ["rejected_reason", String],
            ["change_requested_steps", { "kind": "array", "spec": Relationshipstep.spec }],
            ["change_requested_notes", String],
            ["in_review_has_been_updated", Boolean],
            ["in_review_requested_credit_limit", Number],
            ["in_review_requested_credit_terms", String],
            ...
            ["rejected_by_customer", Boolean],
            ["default_credit_limit_details", String],
            ["change_updated_steps", { "kind": "array", "spec": Relationshipstep.spec }],
            ["configuration_slug", String],
...
export namespace BankAccessToken {
    ...
    export const spec = {
        ...
        fields: () => [
            ...
            ["plaid_access_token", String],
            ["plaid_user_id", String],
            ["plaid_selected_bank_ids", { "kind": "array", "spec": String }],
            ["finicity_customer_id", String],
            ["finicity_username", String],
            ["institution_id", String],
            ["id", Number],
...
export namespace QueuedEmail {
    ...
    export const spec = {
        ...
        fields: () => [
            ["id", Number],
            ["recipient_emails", { "kind": "array", "spec": String }],
            ["recipient_name", String],
            ["cc_emails", { "kind": "array", "spec": String }],
            ["sender", String],
            ["reply_to", { "kind": "array", "spec": String }],
            ["subject", String],
            ["body", String],
            ["sent", Boolean],
            ["created_at", Date],
